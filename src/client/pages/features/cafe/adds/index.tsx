      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 z-10 p-6 sm:p-8 lg:p-10">
            <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-end sm:justify-between sm:gap-5">
              ...
              <div className="flex h-12 w-12 shrink-0 self-end items-center justify-center rounded-full border border-white/20 bg-white/10 text-white backdrop-blur-md transition duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:bg-[#dfa563] group-hover:text-[#2b170c] sm:self-auto">
